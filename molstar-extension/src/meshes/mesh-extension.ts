...
import { BaseGeometry, VisualQuality, VisualQualityOptions } from 'molstar/lib/mol-geo/geometry/base';
...
import { StateObjectRef, StateObjectSelector, StateTransformer } from 'molstar/lib/mol-state';
