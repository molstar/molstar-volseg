...
class Fields_VolumeData3dInfo:
    ...
    def __init__(self, _d: VolumeInfo):
        ...
        self.fields: list[FieldDesc] = [
            ...
            # origin
            number_field_volume3d_info(
                name="origin[0]", value=lambda d, i: _d.origin[0], encoder=byte_array, dtype="f4"
            ),
            number_field_volume3d_info(
                name="origin[1]", value=lambda d, i: _d.origin[1], encoder=byte_array, dtype="f4"
            ),
            number_field_volume3d_info(
                name="origin[2]", value=lambda d, i: _d.origin[2], encoder=byte_array, dtype="f4"
            ),
            # dimensions
            number_field_volume3d_info(
                name="dimensions[0]", value=lambda d, i: _d.dimensions[0], encoder=byte_array, dtype="f4"
            ),
            number_field_volume3d_info(
                name="dimensions[1]", value=lambda d, i: _d.dimensions[1], encoder=byte_array, dtype="f4"
            ),
            number_field_volume3d_info(
                name="dimensions[2]", value=lambda d, i: _d.dimensions[2], encoder=byte_array, dtype="f4"
            ),
            # sampling
            number_field_volume3d_info(
                name="sample_rate", value=lambda d, i: _d.box.downsampling_rate, encoder=byte_array, dtype="i4"
            ),
            number_field_volume3d_info(
                name="sample_count[0]", value=lambda d, i: _d.grid_size[0], encoder=byte_array, dtype="i4"
            ),
            number_field_volume3d_info(
                name="sample_count[1]", value=lambda d, i: _d.grid_size[1], encoder=byte_array, dtype="i4"
            ),
            number_field_volume3d_info(
                name="sample_count[2]", value=lambda d, i: _d.grid_size[2], encoder=byte_array, dtype="i4"
            ),
            # spacegroup
            number_field_volume3d_info(name="spacegroup_number", value=lambda d, i: 1, encoder=byte_array, dtype="i4"),
            number_field_volume3d_info(
                name="spacegroup_cell_size[0]", value=lambda d, i: _d.cell_size[0], encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="spacegroup_cell_size[1]", value=lambda d, i: _d.cell_size[1], encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="spacegroup_cell_size[2]", value=lambda d, i: _d.cell_size[2], encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="spacegroup_cell_angles[0]", value=lambda d, i: 90, encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="spacegroup_cell_angles[1]", value=lambda d, i: 90, encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="spacegroup_cell_angles[2]", value=lambda d, i: 90, encoder=byte_array, dtype="f8"
            ),
            # misc
            number_field_volume3d_info(
                name="mean_source", value=lambda d, i: _d.metadata.mean(1), encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="mean_sampled",
                value=lambda d, i: _d.metadata.mean(_d.box.downsampling_rate),
                encoder=byte_array,
                dtype="f8",
            ),
            number_field_volume3d_info(
                name="sigma_source", value=lambda d, i: _d.metadata.std(1), encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="sigma_sampled",
                value=lambda d, i: _d.metadata.std(_d.box.downsampling_rate),
                encoder=byte_array,
                dtype="f8",
            ),
            number_field_volume3d_info(
                name="min_source", value=lambda d, i: _d.metadata.min(1), encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="min_sampled",
                value=lambda d, i: _d.metadata.min(_d.box.downsampling_rate),
                encoder=byte_array,
                dtype="f8",
            ),
            number_field_volume3d_info(
                name="max_source", value=lambda d, i: _d.metadata.max(1), encoder=byte_array, dtype="f8"
            ),
            number_field_volume3d_info(
                name="max_sampled",
                value=lambda d, i: _d.metadata.max(_d.box.downsampling_rate),
                encoder=byte_array,
                dtype="f8",
            ),
        ]
