...
from cellstar_preprocessor.flows.constants import LATTICE_SEGMENTATION_DATA_GROUPNAME, TIME_INFO_STANDARD
...
def tiff_segmentation_stack_dir_metadata_preprocessing(
    ...
    # # Metadata processing is same as for lattices (masks etc.)
    ...
    #         lattice_gr, segmentation_sampling_info, downsamplings, i
    #     )
