...
def pre_downsample_data(
    ...
    for idx, i in enumerate(inputs):
        if inputs[idx].parameters is not None:
            ...
            # TODO: other types
                ...
                if inputs[idx].kind in {
                    ...
                    p.join()
                elif inputs[idx].kind in {
                    # TODO: resolve - creates folder XXXX.tif instead of file
                    AssetKind.ometiff_image,
                    AssetKind.ometiff_segmentation,
                }:
                    pass
                ...
                elif inputs[idx].kind == AssetKind.sff:
                    # lattice or
                    raise NotImplementedError()
                    # downsample_sff(Path(inputs[idx].path), downsized_input_path.with_suffix('.hff'), factor)
